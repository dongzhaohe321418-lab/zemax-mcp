...
| eye-illumination-zemax-auditable-batch-v2 | 2026-08-18 | Deterministic app exporter + licensed OpticStudio 24.1 C# ZOS-API + independent Python verifier | Export current app tables as immutable audit batches, save one `.zos` per case, and verify all 252 baseline plus cross-model external-lens cases with hashes and explicit PASS/FAIL evidence | Passed |
